...
export default function Contact() {
  ...
  const { isLoading: isSubmitting, sendRequest } = useHttp(CONTACT_URL, contactConfig);
      ...
      <div className="contact-container">
        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <div className="info-item">
              <h3>Email</h3>
              <p><a href="mailto:info@rhinodaizo.com">info@rhinodaizo.com</a></p>
            </div>
            <div className="info-item">
              <h3>Address</h3>
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <textarea id="message" name="message" value={formData.message} onChange={handleChange} required placeholder="Your message here..." rows="5"></textarea>
            </div>
            {submitMessage && (
